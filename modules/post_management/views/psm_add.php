...
<script type="text/javascript" src="<?php echo base_url();?>assets/jquery/tiny_mce/jquery.tinymce.js"></script>
    ...
    <?php echo form_open('post_management/psm_add');?>
  	...
  	<div class="formbox penuh">
        ...
        <div class="tigaperempat border">
        	<div class="formboxitem">
                ...
                <input type="text" name="the_post_title" id="the_post_title" style="width:95%;" />
                <span id="the_url_title" style="font-size:10px;color:#CC0;"></span>
            </div>
            <div class="formboxitem">
	            <textarea name="the_post_content" id="the_post_content" class="tinymce_content" style="width:95%;height:400px;"></textarea>
            </div>
        </div>
        <div class="seperempat last">
        	...
        	<div class="formboxitem">
                ...
                <?
                    ...
                    echo form_dropdown('category_id',$category_id);
                ?>
			</div>
            <div class="formboxitem">
            	<label>Allow Comment ?</label><br />
                <? $the_post_comment=array('0'=>'Yes','1'=>'No');
					echo form_dropdown('the_post_comment',$the_post_comment); ?>
            </div>
            <div class="formboxitem">
            	<label>Tags</label>
