<? $this->load->view('the_master/top'); ?>	
		...
		$(document).ready(function(){
				...
				$('#page_type_id').change(function(){
						...
						else if (page_type_id == '2')
						{
							...
							$.post('<?php echo site_url('page_management/pm_home/page_type_selector/per_category');?>', { the_pt_id : page_type_id },function(data){
	...
	</script><?php echo form_open('page_management/pm_add');?>
    ...
    <div class="penuh formbox">
        ...
        <div class="formboxitem" style="clear:both;">
            <label>Page Type</label><br />
                <? $page_type_id=array();
                    ...
                    echo form_dropdown('the_page_type_id',$page_type_id,'','id="page_type_id"');
                ?> 
        </div>
            ...
            <div id="normal_page">
            	<div class="formboxitem">
                	<label>Title</label><br /><span id="the_url_title" style="font-size:10px;color:#CC0;"></span>
 	                <input type="hidden" name="normal_link_to" id="normal_link_to">
    	            <input type="text" name="the_page_title" style="width:95%;" id="the_page_title">
         	       <br />
                </div>
                <div class="formboxitem">
	                <textarea name="the_page_content" style="width:95%;height:400px;" id="the_page_content" class="tinymce_content"></textarea>
                </div>
            </div>
        ...
        <div class="seperempat last">
            ...
            <div class="formboxitem">
            	<div id="image_library2" style="position:absolute;margin-left:-475px;width:500px;margin-top:-5px;display:none;">
        		<img src="<?php echo base_url();?>assets/blueprint/images/ajax_start.gif"  />	
         		</div>
            ...
            <div class="formboxitem">
    	        ...
    	        <?php echo form_input('the_page_menu');?> 
            </div>
            <div class="formboxitem">
    	        ...
    	        <? $the_page_parent=array();
				   ...
				   echo form_dropdown('the_page_parent',$the_page_parent);
				?><br />
			</div>
